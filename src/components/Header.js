        ...
        <header className="h-16 bg-[#121212]/90 backdrop-blur-md sticky top-0 z-40 flex items-center justify-between px-4 md:px-8 py-4">
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <div className="hidden md:flex gap-2">
                    <button onClick={() => navigate('/')} className="p-1 bg-black/50 rounded-full text-slate-300 hover:text-white" title="Home"><Home size={24} /></button>
