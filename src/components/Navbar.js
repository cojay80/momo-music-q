                ...
                <div className="flex items-center justify-between h-20">
                    <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('/')}>
                        ...
                        <span className="font-bold text-xl tracking-tight text-white group-hover:text-purple-200 transition-colors">
                            MomoMusic<span className="text-purple-500">Q</span>
                        </span>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        ...
                        {user ? (
                            <div className="flex items-center gap-3">
                                ...
                                <button onClick={onLogout} className="p-2.5 rounded-full text-slate-400 hover:text-white hover:bg-white/10 transition-all" title="Log out"><LogOut size={18} /></button>
                            </div>
                        ) : (
